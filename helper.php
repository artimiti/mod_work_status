...
class ModWorkStatusHelper
{
    ...
    public static function getScheduleHtml($params)
    {
        ...
        $days = [
            1 => ['label' => 'Понедельник',     'open_h' => $params->get('mon_open_hour'), 'open_m' => $params->get('mon_open_min'), 'close_h' => $params->get('mon_close_hour'), 'close_m' => $params->get('mon_close_min')],
            2 => ['label' => 'Вторник',         'open_h' => $params->get('tue_open_hour'), 'open_m' => $params->get('tue_open_min'), 'close_h' => $params->get('tue_close_hour'), 'close_m' => $params->get('tue_close_min')],
            3 => ['label' => 'Среда',           'open_h' => $params->get('wed_open_hour'), 'open_m' => $params->get('wed_open_min'), 'close_h' => $params->get('wed_close_hour'), 'close_m' => $params->get('wed_close_min')],
            4 => ['label' => 'Четверг',         'open_h' => $params->get('thu_open_hour'), 'open_m' => $params->get('thu_open_min'), 'close_h' => $params->get('thu_close_hour'), 'close_m' => $params->get('thu_close_min')],
            5 => ['label' => 'Пятница',         'open_h' => $params->get('fri_open_hour'), 'open_m' => $params->get('fri_open_min'), 'close_h' => $params->get('fri_close_hour'), 'close_m' => $params->get('fri_close_min')],
            6 => ['label' => 'Суббота',         'open_h' => $params->get('sat_open_hour'), 'open_m' => $params->get('sat_open_min'), 'close_h' => $params->get('sat_close_hour'), 'close_m' => $params->get('sat_close_min')],
            0 => ['label' => 'Воскресенье',     'open_h' => $params->get('sun_open_hour'), 'open_m' => $params->get('sun_open_min'), 'close_h' => $params->get('sun_close_hour'), 'close_m' => $params->get('sun_close_min')],
        ];
        ...
        foreach ($days as $dayIndex => $day) {
            ...
            $timeText = $isOpen
                ? sprintf('%d:%02d – %d:%02d',
                    (int)$day['open_h'], (int)$day['open_m'],
                    (int)$day['close_h'], (int)$day['close_m'])
                : 'Выходной';
