# Модуль статуса времени работы для Joomla YOOtheme
...
- Поле **«Окончание»** добавляется только к статусам со временем (например, «по Московскому времени»).
- Поле **«Примечание»** текст, заменяющий статус времени в модальном окне (например, «По предварительной договорённости с клиентом»).
...
- **Примечание** — текст, заменяющий статус времени в модальном окне.
